        ...
        init: function() {
            ...
            $cart.on('click', function(e) {
                if ($(e.target).is('span#delete')) {
                    ...
                    /* 下面的商品数量也应该对应减少 */
                    let goods_num1 = Number($('#goods-num').html());
                    let current_num = Number($(e.target).siblings('div.c-b-proCount').children('span.c-b-proCount-input').html())
                    $('#goods-num').html(goods_num1 - current_num);
